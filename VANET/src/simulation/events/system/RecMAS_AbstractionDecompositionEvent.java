 ...
 */
public class RecMAS_AbstractionDecompositionEvent  extends Event{
	 ...
	 */
	public RecMAS_AbstractionDecompositionEvent(ObjectSystemIdentifier raiser)
	{
		this(raiser,-1,-1);
	}
	 ...
	 * @param raiser identifier of the event raiser
	 */
	public RecMAS_AbstractionDecompositionEvent(ObjectSystemIdentifier raiser,int abstractionId,int level)
	{
		super(raiser);
	...
	{
		return "Abstract Agent (id="+this.abstractionId+",lvl="+this.level+") is killed.";
	}
