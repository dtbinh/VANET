 ...
 */
public class MAS_AbstractionUpdateEvent  extends Event{
	 ...
	 */
	public MAS_AbstractionUpdateEvent(ObjectSystemIdentifier raiser)
	{
		this(raiser,-1,-1);
	}
	 ...
	 * @param raiser identifier of the event raiser
	 */
	public MAS_AbstractionUpdateEvent(ObjectSystemIdentifier raiser,int abstractionId,int level)
	{
		super(raiser);
