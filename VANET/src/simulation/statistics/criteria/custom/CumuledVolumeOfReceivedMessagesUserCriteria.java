 ...
 */ 
public class CumuledVolumeOfReceivedMessagesUserCriteria extends UserCriterion{
	...
	public AbstractDataBlock getDataBlock(SimulationJournal journal, int id) {
		...
		while(iter.hasNext())
		{
			...
			{
				if (evt instanceof ReceivedMessageEvent) cumul+=((ReceivedMessageEvent) evt).getMessage().volume();
