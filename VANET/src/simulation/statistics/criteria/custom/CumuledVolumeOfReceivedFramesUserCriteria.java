 ...
 */ 
public class CumuledVolumeOfReceivedFramesUserCriteria extends UserCriterion{
	...
	public AbstractDataBlock getDataBlock(SimulationJournal journal, int id) {
		...
		while(iter.hasNext())
		{
			...
			{
				if (evt instanceof ReceivedFrameEvent) cumul+=((ReceivedFrameEvent) evt).getFrame().getVolume();
