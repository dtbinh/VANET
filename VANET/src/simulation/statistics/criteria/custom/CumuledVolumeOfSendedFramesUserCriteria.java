 ...
 */ 
public class CumuledVolumeOfSendedFramesUserCriteria extends UserCriterion{
	...
	public AbstractDataBlock getDataBlock(SimulationJournal journal, int id) {
		...
		while(iter.hasNext())
		{
			...
			{
				if (evt instanceof SendedFrameEvent) cumul+=((SendedFrameEvent) evt).getFrame().getVolume();
