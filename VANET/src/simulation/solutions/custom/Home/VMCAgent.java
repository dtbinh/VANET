 ...
 */
public class VMCAgent extends Agent implements ObjectAbleToSendMessageInterface{
...
public VMCAgent(MAS mas, Integer id, Float energy,  Integer range) {
		
	super(mas, id, range);
	switch(id)
	{
	case 21: this.name="VMC"; break;
	}		
	try {
			this.setNativeView(new ImageFileBasedObjectView("E:\\traSPArent DATA\\traSPArent Soft\\TestMASH\\TestMASH\\VMC.png"));
			} catch (IOException e) {
