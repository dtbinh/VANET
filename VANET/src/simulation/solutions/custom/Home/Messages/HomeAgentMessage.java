...
public class HomeAgentMessage extends Message{
	 ...
	 * @param message identifier of the type of message
	 */
	public HomeAgentMessage(int sender,int receiver,String message)
	{
		this.sender=sender;
	 ...
	 */
	public static HomeAgentMessage createMessage(byte[] msg)
	{
		...
		return new HomeAgentMessage(sender,receiver,data);
