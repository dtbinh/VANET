...
import simulation.solutions.custom.TrustedRoutingMWAC.*;
...
public class MWACMessage_RouteReply extends MWACMessage {
	...
	public MWACMessage_RouteReply(MWACMessage_RouteReply request) {
		this(request.getSender(), request.getReceiver(),
				request.getIdRequest(), MWACRouteAssistant.cloneRoute(request
						.getRoute()));
	}
	...
	public String toString() {
		return "Route reply #" + this.idRequest + " instancied by "
				+ this.getSender() + " to "
