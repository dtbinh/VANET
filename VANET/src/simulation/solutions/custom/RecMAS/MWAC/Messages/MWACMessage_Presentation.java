...
import simulation.solutions.custom.RecMAS.MWAC.MWACGroupAssistant;
...
public class MWACMessage_Presentation extends MWACMessage
{
	...
	{		
		return "Presentation message instancied by "+this.getSender()+" : [role="+MWACAgent.roleToString(this.role)+",group="+MWACGroupAssistant.groupsToString(this.group)+"]";
	}
}
