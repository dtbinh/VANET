...
public class MWACMessage extends Message{
	...
	/** The route has been checked */
	public final static byte msgQUERY_GROUP_MEMBERS = 13;
	/** The route has been checked */
	public final static byte msgQUERY_GROUP_MEMBERS_REPLY = 14;
	...
	public static MWACMessage createMessage(byte[] msg)
	{
		...
		case MWACMessage.msgQUERY_GROUP_MEMBERS:return new MWACMessage_QueryGroupMembers(sender,receiver);
		case MWACMessage.msgQUERY_GROUP_MEMBERS_REPLY:return new MWACMessage_QueryGroupMembersReply(sender,receiver,data);
		}
