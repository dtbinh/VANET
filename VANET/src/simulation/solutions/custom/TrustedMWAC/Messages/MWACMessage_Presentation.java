...
import simulation.solutions.custom.TrustedMWAC.TrustedMWACAgent;
...
public class MWACMessage_Presentation extends MWACMessage
{
	...
	{		
		return "Presentation message instancied by "+this.getSender()+" : [role="+TrustedMWACAgent.roleToString(this.role)+",group="+MWACGroupAssistant.groupsToString(this.group)+"]";
	}
}
