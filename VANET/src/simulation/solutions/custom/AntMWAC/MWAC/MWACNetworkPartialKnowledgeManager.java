...
/**trouver une route vers le groupe de cette destination
 * */
	public int[] getDataMessageRoute(int dest)
	{
		...
		System.out.println(repr+" est le repr�sentant du message a envoyer");
		...
		if(find) 
		{
			System.out.println("!J'ai trouv� une route "+MWACRouteAssistant.routeToString(route));
			find=false;
			int i=0;
			//System.out.println("Je vais rentr� dans la boucle");
		...
		else
		{
			...
			System.out.println("Je N'ai PAS trouv� une route");
			return null;
		}

	}
/** retourne le sender de idRouteRequest
 * **/
