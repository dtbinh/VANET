...
public class MWACMessage extends Message{
	...
	/*****************msg fourmis*************************************************/
	public final static byte msgINITIALIZATION = 13;

	public final static byte msgFORWARD_ANT = 14;
	
	public final static byte msgBACKWARD_ANT = 15;
	
	public final static byte msgUPDATE = 16;
   ...
   /********************************************************************************/
	...
	public static MWACMessage createMessage(byte[] msg)
	{
		...
		{
			System.out.println("Unknown MWAC message (not enougth bytes)");
			return null;
		}
		...
		//les msg  qui concernent la couche  fourmis 
		
		case MWACMessage.msgFORWARD_ANT :       return new AntMessage_Forward(sender,receiver, data);
		case MWACMessage.msgINITIALIZATION:		return new AntMessage_Initialisation(sender,receiver,data);
		case MWACMessage.msgBACKWARD_ANT: 		return new AntMessage_Backward(sender,receiver,data);
		case MWACMessage.msgUPDATE: 			return new AntMessage_Update(sender,receiver,data); 
	...
	public byte[] toByteSequence(byte[] data) {
		//System.out.println("On me demande de cr�er un msg de type "+this.typeMsg+" � partir de "+ASTRO_Message.debugByteArray(data));
		if(data==null)
