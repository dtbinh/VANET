...
public class DSRSocialMessage_ServicesRequest extends DSRSocialMessage
{
	...
	public DSRSocialMessage_ServicesRequest(int sender,int receiver, short idRequest, byte TTL,int[] services,int[] route)
	{
		super(sender,receiver,DSRSocialMessage.SERVICES_REQUEST);
	...
	public DSRSocialMessage_ServicesRequest(int sender,int receiver,byte[] data)
	{
		super(sender,receiver,DSRSocialMessage.SERVICES_REQUEST);
	...
	{
			return "Services request #"+this.idRequest+" instancied by "+this.getSender()+" to "+DSRSocialFrame.receiverIdToString(this.getReceiver())+"TTL="+this.TTL+"   Route is "+MWACSocialRouteAssistant.integerArrayToString(this.route)+"   Searched services are "+MWACSocialRouteAssistant.integerArrayToString(this.services);
	}
}
