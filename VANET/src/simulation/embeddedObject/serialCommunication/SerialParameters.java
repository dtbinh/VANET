...
public class SerialParameters {
	...
	{
		this(portName,baudRate,databits,stopbits,parity,SerialPort.FLOWCONTROL_NONE);
	}
	 ...
	 * @see SerialPort contains used constants
	 */
	public SerialParameters(String portName,int baudRate,int databits,int stopbits,int parity,int flowControl)
	{
		this(portName,baudRate,databits,stopbits,parity,flowControl,flowControl);
	}
	/**
    Paramaterized constructer.
	 * @param portName The name of the port.
	...
	public String getDatabitsString() {
		...
		case SerialPort.DATABITS_8:
			return "8";
		default:
			return "Unkown value("+this.getDatabits()+")";
		}
	}
	...
	public String getStopbitsString() {
		...
		case SerialPort.STOPBITS_2:
			return "2";
		default:
			return "Unkown value("+this.getStopbits()+")";
		}
	}
	...
	public String getParityString() {
		...
		case SerialPort.PARITY_ODD:
			return "Odd";
		default:
			return "Unkown value("+this.getParity()+")";
		}
	}
	 ...
	 */
	public String flowToString(int flowControl) {
		switch(flowControl) {
	...
	{
		return "Port name="+this.getPortName()+" Baud rate="+this.getBaudRateString()+" Flow control in="+this.flowToString(this.getFlowControlIn())+" Flow control out="+this.flowToString(this.getFlowControlOut())+" Data bits="+this.getDatabitsString()+" Stop bits="+this.getStopbitsString()+" Parity="+this.getParityString();
	}
}
