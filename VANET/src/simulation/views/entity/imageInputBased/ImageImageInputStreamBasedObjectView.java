...
public class ImageImageInputStreamBasedObjectView implements ImageBasedObjectViewInterface
{
	private BufferedImage environmentView;
	private boolean hasBeenUpdated;

	public ImageImageInputStreamBasedObjectView(ImageInputStream stream) throws IOException
	{
