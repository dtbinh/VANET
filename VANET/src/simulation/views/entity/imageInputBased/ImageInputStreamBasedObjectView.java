...
public class ImageInputStreamBasedObjectView implements ImageBasedObjectViewInterface
{
	private BufferedImage environmentView;
	private boolean hasBeenUpdated;

	
	public ImageInputStreamBasedObjectView(InputStream input) throws IOException
	{
